...
git_sparse_clone openwrt-25.12 https://github.com/immortalwrt/luci applications/luci-app-firewall
...
rm -rf feeds/luci/applications/{luci-app-firewall,luci-app-dockerman,luci-app-samba4,luci-app-aria2,luci-app-diskman}
